...
│   ├── GoogleAnalytics.tsx     # GA4 client component (next/script) — renders only if NEXT_PUBLIC_GA_ID is set; verify it's actually set on Railway, not just .env.local
